class ZCL_ZMB_ODATA_GIT_1_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZMB_ODATA_GIT_1_MPC=======CP' ##NO_TEXT.
...
CLASS ZCL_ZMB_ODATA_GIT_1_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZMB_ODATA_GIT_1_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZOVBAK'
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20231110154031'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Remark'.                 "#EC NOTEXT
