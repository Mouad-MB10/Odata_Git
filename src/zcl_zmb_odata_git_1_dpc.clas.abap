class ZCL_ZMB_ODATA_GIT_1_DPC definition
  public
...
protected section.
  ...
  methods SOHEADERSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZMB_ODATA_GIT_1_MPC=>TS_SOHEADER
    raising
  ...
  methods SOHEADERSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZMB_ODATA_GIT_1_MPC=>TT_SOHEADER
...
CLASS ZCL_ZMB_ODATA_GIT_1_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 10.11.2023 16:40:43 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZMB_ODATA_GIT_1_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA soheaderset_create_entity TYPE zcl_zmb_odata_git_1_mpc=>ts_soheader.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA soheaderset_get_entity TYPE zcl_zmb_odata_git_1_mpc=>ts_soheader.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZMB_ODATA_GIT_1_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA soheaderset_get_entityset TYPE zcl_zmb_odata_git_1_mpc=>tt_soheader.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA soheaderset_update_entity TYPE zcl_zmb_odata_git_1_mpc=>ts_soheader.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
